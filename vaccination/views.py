...
class VaccinationViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields = ['status', 'vaccine_type', 'livestock__tag_id']
    search_fields = ['vaccine_name', 'livestock__tag_id']
    ordering_fields = ['next_due_date', 'date_given', 'created_at']

    def get_queryset(self):
        return Vaccination.objects.filter(user=self.request.user).select_related('livestock')
    ...
    def counts(self, request):
        ...
        # Note: Frontend handles 'completed' as placeholder
