...
function TransferHeader({ transfer }) {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
      <h3 className="text-sm font-semibold text-gray-700 mb-4 uppercase tracking-wide">{t('reviewTransfer.animal')}</h3>
        ...
        <div className="flex-1">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <span className="text-sm text-gray-600">{t('reviewTransfer.breed')}:</span>
              <span className="text-sm font-medium text-gray-900">{breed}</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-sm text-gray-600">{t('reviewTransfer.gender')}:</span>
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm text-gray-600">{t('reviewTransfer.date')}:</span>
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        <h4 className="text-sm font-semibold text-gray-700 mb-2">{t('reviewTransfer.reason')}</h4>
        <p className="text-sm text-gray-700 leading-relaxed">
          {transfer.reason || t('transferModal.reasonPlaceholder')}
        </p>
      </div>
    </div>
  );
